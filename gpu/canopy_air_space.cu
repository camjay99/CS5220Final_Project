...
__device__ double calculate_grashof_number(double air_temp, double leaf_temp, double leaf_size) {
...
__device__ double calculate_free_nusselt_number(double air_temp, double leaf_temp, double leaf_size) {
...
__device__ double calculate_reynolds_number(double wind_speed, double leaf_size, double thermal_dif) {
    return wind_speed*leaf_size / thermal_dif;
}

__device__ double calculate_forced_nusselt_number(double wind_speed, double leaf_size, double thermal_dif) {
